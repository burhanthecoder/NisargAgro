...
class BillingProfile(models.Model):
    ...
    plan = models.ForeignKey(
        Plan, blank=True, null=True, on_delete=models.SET_NULL)
...
class Invoice(models.Model):
    ...
    total_amt_paid = models.FloatField(default=0)
...
class InventoryLog(models.Model):
    ...
    associated_invoice = models.ForeignKey(
        Invoice, blank=True, null=True, default=None, on_delete=models.SET_NULL)
...
class Inventory(models.Model):
    ...
    last_log = models.ForeignKey(
        InventoryLog, null=True, blank=True, default=None, on_delete=models.SET_NULL)
...
class Book(models.Model):
    ...
    last_log = models.ForeignKey(
        'BookLog', null=True, blank=True, default=None, on_delete=models.SET_NULL)
