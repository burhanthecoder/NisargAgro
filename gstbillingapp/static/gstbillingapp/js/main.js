...
function balance_amount() {
  ...
  var invoice_total_amt_with_gst = parseFloat(
    element
      .parent()
      .parent()
      .find("input[name=invoice_total_amt_with_gst]")
      .val()
  );

  var balance_left = invoice_total_amt_with_gst - total_amt_paid;

  element.parent().parent().find("input[name=balance-left]").val(balance_left);
}
